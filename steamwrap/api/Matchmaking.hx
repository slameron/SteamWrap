...
class Matchmaking extends SteamBase {
	...
	/**
	 * Called when a lobby update is received. Needs 4 strings, The ID of the lobby, ID of person changed, ID of person making change, bitwise values of changes 
	 */
	public var whenLobbyUpdate:{
		lobbyID:String,
		changedID:String,
		makingChangeID:String,
		flags:String
	} -> Void = null;
